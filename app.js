...
swagger.addModels(models)
  ...
  .addGet(routes.users.getRandomWithFriends)
  .addGet(routes.users.findByIdWithFriends)
  .addGet(routes.users.getWithFriendsAndFOF)
  .addGet(routes.users.getWithFOF)
...
swagger.configure(BASE_URL+API_STRING, "0.0.8");
